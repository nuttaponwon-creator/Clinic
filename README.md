...
เพื่อให้เห็นภาพการทำงานของระบบในบทบาทที่แตกต่างกัน คุณสามารถเลือกใช้บัญชีที่เตรียมไว้ หรือสมัครใหม่ได้ดังนี้:

| บทบาท (Role) | Username | Password | หมายเหตุ |
|---|---|---|---|
| **Admin** | `admin` | `12555879ad` | จัดการระบบและสต็อกสินค้าได้ทั้งหมด |
| **Vet (สัตวแพทย์)** | `vet1` - `vet4` | `changeme123` | จัดการการนัดหมายและบันทึกการรักษา |

> [!IMPORTANT]
> **สำหรับการทดสอบในบทบาทเจ้าของสัตว์เลี้ยง (Owner):**
> เพื่อประสบการณ์การทดสอบที่สมบูรณ์ที่สุด **แนะนำให้สมัครบัญชีใหม่** ด้วยตนเองแทนการใช้บัญชีเก่าที่มีอยู่ เพื่อให้คุณสามารถทดสอบขั้นตอนการลงทะเบียน (Registration Flow), การเพิ่มข้อมูลสัตว์เลี้ยงใหม่ และการจัดการนัดหมายผ่านหน้า My Page ของตนเองได้อย่างครบถ้วนครับ
